...
VM_SKU_PRICING = {
    "Standard_B2s": {"eastus": 0.042, "westus": 0.045, "northeurope": 0.048, "southeastasia": 0.050, "australiaeast": 0.052},
    "Standard_D4s_v3": {"eastus": 0.192, "westus": 0.205, "northeurope": 0.210, "southeastasia": 0.220, "australiaeast": 0.225},
    "Standard_E8s_v3": {"eastus": 0.504, "westus": 0.538, "northeurope": 0.550, "southeastasia": 0.575, "australiaeast": 0.590},
    "Standard_D2s_v4": {"eastus": 0.096, "westus": 0.102, "northeurope": 0.105, "southeastasia": 0.110, "australiaeast": 0.115},
    "Standard_F4s_v2": {"eastus": 0.169, "westus": 0.180, "northeurope": 0.185, "southeastasia": 0.195, "australiaeast": 0.200},
}
...
for day in range(days):
    ...
    if date.day == 1:  # Report on first day of month
        for storage_config in storage_configs:
            monthly_cost = (storage_config["storage_size_gb"] * 
                          STORAGE_PRICING[storage_config["storage_tier"]])
...
print("\n" + "=" * 60)
print(f"Synthetic dataset 'azure_compute_usage_6months.csv' generated successfully!")
print("=" * 60)
